...
export default function Finalization() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white font-sans">
      ...
      <nav className="bg-black text-white flex items-center justify-center gap-10 w-full py-3">
        <div className="text-2xl font-bold hover:underline cursor-pointer">Comissão</div>
        <img src="/logo.png" alt="Logo" className="h-20" />
        <a href="#" className="text-2xl font-bold hover:underline cursor-pointer">Entregas Pendentes</a>
      </nav>
